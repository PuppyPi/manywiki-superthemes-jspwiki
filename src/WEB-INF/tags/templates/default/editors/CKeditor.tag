...
<wiki:RequestResource type="script" resource="scripts/ckeditor/ckeditor.js" />

<%-- Use CKEditor from a CDN --%>
<%-- <wiki:RequestResource type="script" resource="//cdn.ckeditor.com/4.5.1/standard/ckeditor.js" /> --%>
